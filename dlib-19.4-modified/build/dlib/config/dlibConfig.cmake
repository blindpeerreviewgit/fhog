...
set(dlib_LIBRARIES ${dlib_LIBRARIES} "-lpthread;/usr/lib/x86_64-linux-gnu/libnsl.so;/usr/lib/x86_64-linux-gnu/libSM.so;/usr/lib/x86_64-linux-gnu/libICE.so;/usr/lib/x86_64-linux-gnu/libX11.so;/usr/lib/x86_64-linux-gnu/libXext.so;/usr/lib/x86_64-linux-gnu/libpng.so;/usr/lib/x86_64-linux-gnu/libjpeg.so;/usr/lib/libopenblas.so;/usr/local/cuda/lib64/libcublas.so;/usr/local/cuda/lib64/libcudnn.so;/usr/local/cuda/lib64/libcurand.so;/usr/local/cuda/lib64/libcusolver.so;/usr/lib/x86_64-linux-gnu/libiomp5.so")
set(dlib_LIBS      ${dlib_LIBRARIES} "-lpthread;/usr/lib/x86_64-linux-gnu/libnsl.so;/usr/lib/x86_64-linux-gnu/libSM.so;/usr/lib/x86_64-linux-gnu/libICE.so;/usr/lib/x86_64-linux-gnu/libX11.so;/usr/lib/x86_64-linux-gnu/libXext.so;/usr/lib/x86_64-linux-gnu/libpng.so;/usr/lib/x86_64-linux-gnu/libjpeg.so;/usr/lib/libopenblas.so;/usr/local/cuda/lib64/libcublas.so;/usr/local/cuda/lib64/libcudnn.so;/usr/local/cuda/lib64/libcurand.so;/usr/local/cuda/lib64/libcusolver.so;/usr/lib/x86_64-linux-gnu/libiomp5.so")
